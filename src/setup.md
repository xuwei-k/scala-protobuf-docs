...
Pythonのインストール後、Pathを通すか、以下のように [`pythonExe`](https://github.com/thesamet/sbt-protoc/blob/v0.99.9/src/main/scala/sbtprotoc/ProtocPlugin.scala#L24) というkeyを設定してください。
...
- sbt-protocは、[このような設定になっているため](https://github.com/thesamet/sbt-protoc/blob/v0.99.9/src/main/scala/sbtprotoc/ProtocPlugin.scala#L54) addSbtPlugin を設定しただけで、デフォルトで有効になります。
