...
Pythonのインストール後、Pathを通すか、以下のように [`pythonExe`](https://github.com/thesamet/sbt-protoc/blob/v0.99.6/src/main/scala/sbtprotoc/ProtocPlugin.scala#L24) というkeyを設定してください。
...
- sbt-protocは、[このような設定になっているため](https://github.com/thesamet/sbt-protoc/blob/v0.99.6/src/main/scala/sbtprotoc/ProtocPlugin.scala#L79) addSbtPlugin を設定しただけで、デフォルトで有効になります。
